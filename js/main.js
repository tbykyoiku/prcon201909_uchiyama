...
window.addEventListener('load', () => {
  ...
  function imageload() {
    ...
    var cvs = document.getElementById("draw-area");
    var ctx = cvs.getContext('2d');
    var arr = ['image/angry_fukureru_boy.png','image/angry_fukureru_girl.png','image/chance_tsukamu_man.png','image/chance_tsukamu_woman.png','image/fusagikomu_businessman.png','image/fusagikomu_businesswoman.png','image/fusagikomu_man.png',
'image/fusagikomu_woman.png','image/kagenagara_ouuen_man.png','image/kagenagara_ouuen_woman.png','image/pistol_pose_man.png','image/pistol_pose_woman.png','image/pose_koshi_nukeru_kowai_man.png','image/pose_koshi_nukeru_kowai_woman.png',
'image/pose_kuyashii_man.png','image/pose_kuyashii_woman.png','image/pose_pistol_man.png','image/pose_pistol_woman.png','image/pose_syazai_sliding_dogeza_man.png','image/pose_syazai_sliding_dogeza_woman.png',
'image/pose_udemakuri_man.png','image/pose_udemakuri_woman.png','image/pose_ukkari_man.png','image/pose_ukkari_woman.png'
];
  ...
  function initEventHandler() {
    ...
    loadButton.addEventListener('click', imageload);
